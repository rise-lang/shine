...
final case class mapLocal(dim: Int) extends Builder {
  override def toString: String = "mapLocal"
  override def primitive: rise.core.Primitive = mapLocal.Primitive(dim)()
  override def apply: ToBeTyped[rise.core.Primitive] = toBeTyped(mapLocal.Primitive(dim)())
...
object mapLocal {
  private final case class Primitive(dim: Int)(override val t: Type = TypePlaceholder) extends rise.core.Primitive {
    override val name: String = "mapLocal"
