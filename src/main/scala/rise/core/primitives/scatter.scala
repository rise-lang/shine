...
object scatter extends Builder {
  private final case class Primitive()(override val t: Type = TypePlaceholder) extends rise.core.Primitive {
    ...
    override def typeScheme: Type = impl { (n: Nat) => impl { (m: Nat) => impl { (t: DataType) => ArrayType(n, IndexType(m)) ->: ArrayType(n, t) ->: ArrayType(m, t) } } }
  }
  override def toString: String = "scatter"
