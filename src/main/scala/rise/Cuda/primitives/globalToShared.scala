...
object globalToShared extends Builder {
  private final case class Primitive()(override val t: Type = TypePlaceholder) extends rise.core.Primitive {
    ...
    override def typeScheme: Type = impl { (t: DataType) => t ->: t }
  }
  override def toString: String = "globalToShared"
