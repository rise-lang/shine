...
object gap8RunPrimitive extends Builder {
  private final case class Primitive()(override val t: ExprType = TypePlaceholder) extends rise.core.Primitive {
    ...
    override def typeScheme: ExprType = expl { (cores: Nat) => impl { (t: DataType) => t ->: t } }
  }
  override def toString: String = "gap8RunPrimitive"
