\begin{figure}[b]
    ...
    \begin{minipage}{.4\linewidth}
      ...
      \end{mathpar}
      \subcaption{Accessibility}\label{fig:accessib8ility-kinding}
    \end{minipage}
    %
    \begin{minipage}{.4\linewidth}
      \begin{mathpar}
    ...
    \begin{minipage}{.4\linewidth}
      \begin{mathpar}
        ...
        {\Delta \vdash \lNtN{\n}{\Nat{M}} : \ntnkind}
      \end{mathpar}
      \subcaption{$\natkind$ to $\natkind$ type level functions}\label{fig:nat2nat-kinding}
    \end{minipage}
    %
    \begin{minipage}{.4\linewidth}
      \begin{mathpar}
      ...
      \end{mathpar}
      \subcaption{$\natkind$ to $\datatype$ type level functions}\label{fig:nat2data-kinding}
    \end{minipage}
