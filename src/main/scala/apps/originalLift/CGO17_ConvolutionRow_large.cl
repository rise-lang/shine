    ...
    /* iteration count is exactly 1, no loop emitted */
    {
      ...
      /* iteration count is exactly 1, no loop emitted */
      {
        ...
        /* iteration count is exactly 1, no loop emitted */
        {
          ...
          v__177[(v_l_id_169 + (81 * v_l_id_167))] = id(v__174[(v_l_id_167 + (16 * v_wg_id_166) + (8192 * ( ((-8 + v_l_id_169 + (64 * v_wg_id_165)) >= 0) ? ( ((-8 + v_l_id_169 + (64 * v_wg_id_165)) < 8192) ? (-8 + v_l_id_169 + (64 * v_wg_id_165)) : 8191 ) : 0 )))]);
        }
        
        /* iteration count is exactly 1, no loop emitted */
        {
          int v_l_id_169 = get_local_id(1);
          v__177[(8 + v_l_id_169 + (81 * v_l_id_167))] = id(v__174[(v_l_id_167 + (8192 * v_l_id_169) + (524288 * v_wg_id_165) + (16 * v_wg_id_166))]);
        }
        
        /* iteration count is exactly 1, no loop emitted */
        {
          int v_l_id_169 = get_local_id(1);
          v__177[(16 + v_l_id_169 + (81 * v_l_id_167))] = id(v__174[(65536 + v_l_id_167 + (8192 * v_l_id_169) + (524288 * v_wg_id_165) + (16 * v_wg_id_166))]);
        }
        
        /* iteration count is exactly 1, no loop emitted */
        {
          int v_l_id_169 = get_local_id(1);
          v__177[(24 + v_l_id_169 + (81 * v_l_id_167))] = id(v__174[(131072 + v_l_id_167 + (8192 * v_l_id_169) + (524288 * v_wg_id_165) + (16 * v_wg_id_166))]);
        }
        
        /* iteration count is exactly 1, no loop emitted */
        {
          int v_l_id_169 = get_local_id(1);
          v__177[(32 + v_l_id_169 + (81 * v_l_id_167))] = id(v__174[(196608 + v_l_id_167 + (8192 * v_l_id_169) + (524288 * v_wg_id_165) + (16 * v_wg_id_166))]);
        }
        
        /* iteration count is exactly 1, no loop emitted */
        {
          int v_l_id_169 = get_local_id(1);
          v__177[(40 + v_l_id_169 + (81 * v_l_id_167))] = id(v__174[(262144 + v_l_id_167 + (8192 * v_l_id_169) + (524288 * v_wg_id_165) + (16 * v_wg_id_166))]);
        }
        
        /* iteration count is exactly 1, no loop emitted */
        {
          int v_l_id_169 = get_local_id(1);
          v__177[(48 + v_l_id_169 + (81 * v_l_id_167))] = id(v__174[(327681 + v_l_id_167 + (8192 * v_l_id_169) + (524288 * v_wg_id_165) + (16 * v_wg_id_166))]);
        }
        
        /* iteration count is exactly 1, no loop emitted */
        {
          int v_l_id_169 = get_local_id(1);
          v__177[(56 + v_l_id_169 + (81 * v_l_id_167))] = id(v__174[(393216 + v_l_id_167 + (8192 * v_l_id_169) + (524288 * v_wg_id_165) + (16 * v_wg_id_166))]);
        }
        
        /* iteration count is exactly 1, no loop emitted */
        {
          int v_l_id_169 = get_local_id(1);
          v__177[(64 + v_l_id_169 + (81 * v_l_id_167))] = id(v__174[(458752 + v_l_id_167 + (8192 * v_l_id_169) + (524288 * v_wg_id_165) + (16 * v_wg_id_166))]);
        }
        
        /* iteration count is exactly 1, no loop emitted */
        {
          int v_l_id_169 = get_local_id(1);
          v__177[(72 + v_l_id_169 + (81 * v_l_id_167))] = id(v__174[(v_l_id_167 + (16 * v_wg_id_166) + (8192 * ( ((64 + v_l_id_169 + (64 * v_wg_id_165)) >= 0) ? ( ((64 + v_l_id_169 + (64 * v_wg_id_165)) < 8192) ? (64 + v_l_id_169 + (64 * v_wg_id_165)) : 8191 ) : 0 )))]);
        }
      ...
      for (int v_l_id_170 = get_local_id(1);v_l_id_170<64;v_l_id_170 = (8 + v_l_id_170)){
        /* iteration count is exactly 1, no loop emitted */
        {
          ...
          /* map_seq */
          /* unroll */
          v__183[(v_l_id_171 + (8192 * v_l_id_170) + (524288 * v_wg_id_165) + (16 * v_wg_id_166))] = id(v__178);
          /* end unroll */
          /* end map_seq */
        }
      }
