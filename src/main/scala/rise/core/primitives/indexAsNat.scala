...
object indexAsNat extends Builder {
  private final case class Primitive()(override val t: ExprType = TypePlaceholder) extends rise.core.Primitive {
    ...
    override def typeScheme: ExprType = impl { (n: Nat) => IndexType(n) ->: NatType }
  }
  override def toString: String = "indexAsNat"
