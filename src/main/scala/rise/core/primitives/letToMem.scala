...
object letToMem extends Builder {
  private final case class Primitive()(override val t: ExprType = TypePlaceholder) extends rise.core.Primitive {
    ...
    override def typeScheme: ExprType = impl { (s: DataType) => impl { (t: DataType) => s ->: (s ->: t) ->: t } }
  }
  override def toString: String = "letToMem"
