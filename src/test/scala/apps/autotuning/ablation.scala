...
class ablation extends test_util.Tests {
  ...
  test("constraints test mm") {
    ...
    val configs = Seq(
      s"autotuning/config/ablation/mm/mm_base.json",
    )
  ...
  test("constraints test scal") {
    ...
    val configs = Seq(
      s"autotuning/config/ablation/scal/scal_base.json",
    )
    ...
    val configs2 = Seq(
      s"autotuning/config/ablation/scal/scal_faes.json",
      s"autotuning/config/ablation/scal/scal_faes0.json"
    )
