...
object asVectorAligned extends Builder {
  private final case class Primitive()(override val t: Type = TypePlaceholder) extends rise.core.Primitive {
    ...
    override def typeScheme: Type = expl { (n: Nat) => impl { (m: Nat) => impl { (t: DataType) => ArrayType(m * n, t) ->: ArrayType(m, VectorType(n, t)) } } }
  }
  override def toString: String = "asVectorAligned"
