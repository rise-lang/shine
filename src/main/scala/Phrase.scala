...
case class Record(fields: Phrase[ExpType]*) extends Phrase[ExpType]
...
case class ReducePhrase(f: Phrase[ExpType x ExpType -> ExpType], init: Phrase[ExpType], array: Phrase[ExpType]) extends Phrase[ExpType]
