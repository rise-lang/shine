...
object vectorFromScalar extends Builder {
  private final case class Primitive()(override val t: ExprType = TypePlaceholder) extends rise.core.Primitive {
    ...
    override def typeScheme: ExprType = impl { (n: Nat) => impl { (t: DataType) => t ->: VectorType(n, t) } }
  }
  override def toString: String = "vectorFromScalar"
