...
final case class mapWorkGroup(dim: Int) extends Builder {
  override def toString: String = "mapWorkGroup"
  override def primitive: rise.core.Primitive = mapWorkGroup.Primitive(dim)()
  override def apply: ToBeTyped[rise.core.Primitive] = toBeTyped(mapWorkGroup.Primitive(dim)())
...
object mapWorkGroup {
  private final case class Primitive(dim: Int)(override val t: Type = TypePlaceholder) extends rise.core.Primitive {
    override val name: String = "mapWorkGroup"
