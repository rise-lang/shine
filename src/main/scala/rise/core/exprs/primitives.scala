...
object primitives {
  ...
  @primitive object slide extends Primitive with Builder {
    impl { n: Nat =>
      expl((sz: Nat) => expl((sp: Nat) => impl { t: DataType =>
        ((sp * n + sz) `.` t) ->: ((1 + n) `.` sz `.` t)
      }))
    }
  }
  ...
  @primitive object add extends Primitive with Builder {
    impl { t: DataType => t ->: t ->: t }
  }

  @primitive object sub extends Primitive with Builder {
    impl { t: DataType => t ->: t ->: t }
  }

  @primitive object mul extends Primitive with Builder {
    impl { t: DataType => t ->: t ->: t }
  }

  @primitive object div extends Primitive with Builder {
    impl { t: DataType => t ->: t ->: t }
  }

  @primitive object mod extends Primitive with Builder {
    impl { t: DataType => t ->: t ->: t }
  }

  @primitive object gt extends Primitive with Builder {
    impl { t: DataType => t ->: t ->: bool }
  }

  @primitive object lt extends Primitive with Builder {
    impl { t: DataType => t ->: t ->: bool }
  }

  @primitive object equal extends Primitive with Builder {
    impl { t: DataType => t ->: t ->: bool }
  }
