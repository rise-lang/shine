...
\begin{figure*}
    ...
    \begin{minipage}{1.0\linewidth}
      ...
      \end{mathpar}
      \subcaption{Structural Rules}\label{fig:lift-structural-rules}
    \end{minipage}
    ...
    \begin{minipage}{1.0\linewidth}
      ...
      \end{mathpar}
      \subcaption{Introduction and Elimination Rules}\label{fig:lift-intro-elim-rules}
    \end{minipage}
    ...
    \begin{minipage}{1.0\linewidth}
      ...
      \end{mathpar}
      \subcaption{Access conversion rule}\label{fig:lift-access-conversion-rule}
    \end{minipage}
