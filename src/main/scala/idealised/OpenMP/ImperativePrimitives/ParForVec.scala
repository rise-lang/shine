...
//import idealised.DPIA.Phrases.{Lambda, Phrase}
...
//
//  override def codeGen[Environment, Path, Stmt, Expr, Decl](gen: Compilation.CodeGenerator[Environment, Path, Stmt, Expr, Decl])
