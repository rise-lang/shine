...
// This class models OpenCL built in functions that can appear
// inside of arithmetic expressions examples are get_global_size(0),
// or get_local_id(1), but also OpenCL math functions, e.g., ceil or sin
class BuiltInFunctionCall private(name: String, val param: Int, range: Range)
  ...
  override val HashSeed: Int = 0x31111111
