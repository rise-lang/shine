...
class Slide extends test_util.Tests {
  ...
  test(
    "Simple slide example should generate syntactic valid C code with two for loops"
  ) {
    val e =
      nFun(n =>
  ...
  test(
    "Simple 2D slide example with separate maps should generate syntactic valid OpenMP code with three for loops"
  ) {
    val e =
      nFun(n =>
        nFun(m =>
  ...
  test(
    "Simple 2D slide example with merged maps should generate syntactic valid OpenMP code with three for loops"
  ) {
    val e =
      nFun(n =>
        nFun(m =>
