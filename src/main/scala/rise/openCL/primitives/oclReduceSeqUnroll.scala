...
object oclReduceSeqUnroll extends Builder {
  private final case class Primitive()(override val t: ExprType = TypePlaceholder) extends rise.core.Primitive {
    ...
    override def typeScheme: ExprType = expl { (a: AddressSpace) => impl { (n: Nat) => impl { (s: DataType) => impl { (t: DataType) => (t ->: s ->: t) ->: t ->: ArrayType(n, s) ->: t } } } }
  }
  override def toString: String = "oclReduceSeqUnroll"
