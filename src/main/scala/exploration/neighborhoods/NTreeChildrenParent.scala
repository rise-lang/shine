...
/**
  * Neighborhood is defined by children and parent of current solution
  */
case class NTreeChildrenParent(
                                runner: Runner[Rise],
  ...
  override def N(solution: Solution[Rise]): Seq[Solution[Rise]] = {
    ...
    // add parent element to neighborhood
    val parent: Solution[Rise] = Solution[Rise](solution.solutionSteps.dropRight(1))
