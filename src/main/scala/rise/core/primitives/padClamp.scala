...
object padClamp extends Builder {
  private final case class Primitive()(override val t: ExprType = TypePlaceholder) extends rise.core.Primitive {
    ...
    override def typeScheme: ExprType = impl { (n: Nat) => expl { (l: Nat) => expl { (r: Nat) => impl { (t: DataType) => ArrayType(n, t) ->: ArrayType(l + n + r, t) } } } }
  }
  override def toString: String = "padClamp"
