...
kernel void KERNEL(const global float* restrict v__28, const global float* restrict v__29, float v__30, float v__31, global Tuple_float4_float4* v__39, int v_N_0){
  /* Static local memory */
  /* Typed Value memory */
  float4 v__34;
  /* Private Memory */
  /* iteration count is exactly 1, no loop emitted */
  {
    ...
    for (int v_i_26 = 0;v_i_26<v_N_0;v_i_26 = (1 + v_i_26)){
      v__34 = calcAcc(vload4(v_gl_id_25,v__28), vload4(v_i_26,v__28), v__31, v__30, v__34);
    }
    /* end reduce_seq */
    /* map_seq */
    /* iteration count is exactly 1, no loop emitted */
    {
      int v_i_27 = 0;
      v__39[v_gl_id_25] = update(vload4(v_gl_id_25,v__28), vload4(v_gl_id_25,v__29), v__31, v__34);
    }
    /* end map_seq */
  }
}