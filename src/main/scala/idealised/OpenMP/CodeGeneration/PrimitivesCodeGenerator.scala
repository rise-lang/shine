...
object PrimitivesCodeGenerator {
  ...
  def toOpenMP(a: Assign, block: Block, env: CodeGenerator.Environment): Block = {
  ...
  def toOpenMP(f: For, block: Block, env: CodeGenerator.Environment): Block = {
    import opencl.generator.OpenCLAST._
  ...
  def toOpenMP(d: DoubleBufferFor, block: Block, env: CodeGenerator.Environment): Block = {
    import opencl.generator.OpenCLAST._
  ...
  def toOpenMP(n: New, block: Block, env: CodeGenerator.Environment): Block = {
  ...
  def toOpenMP(s: idealised.DPIA.ImperativePrimitives.Seq,
               block: Block,
  ...
  def toOpenMP(s: idealised.DPIA.ImperativePrimitives.Skip,
               block: Block,
               env: CodeGenerator.Environment): Block = {
    (block: Block) += OpenCLAST.Comment("skip")
  }

  def toOpenMP(pf: ParFor,
               block: Block,
               env: CodeGenerator.Environment): Block = {

    OpenMPParFor(pf.n, pf.dt, pf.out, pf.body).codeGenCmd(block, env)
  }

  // ==== generating expressions  ==== //

  def toOpenMP(g: Gather,
  ...
  def toOpenMP(l: DPIA.Phrases.Literal,
               env: CodeGenerator.Environment,
               dt: DataType,
               arrayAccess: List[ArithExpr],
               tupleAccess: List[ArithExpr]): Expression = {
