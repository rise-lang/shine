...
object primitives {
  ...
  @primitive case class DepJoin()(override val t: Type = TypePlaceholder) extends Primitive {
  ...
  @primitive case class DepMapSeq()(override val t: Type = TypePlaceholder) extends Primitive {
  ...
  @primitive case class Drop()(override val t: Type = TypePlaceholder) extends Primitive {
  ...
  @primitive case class Generate()(override val t: Type = TypePlaceholder) extends Primitive {
    override def typeScheme: Type = implN(n => implDT(t =>
      (IndexType(n) ->: t) ->: ArrayType(n, t)
    ))
  }

  @primitive case class Idx()(override val t: Type = TypePlaceholder) extends Primitive {
    override def typeScheme: Type = implN(n => implDT(t =>
      IndexType(n) ->: ArrayType(n, t) ->: t
    ))
  }

  @primitive case class Id()(override val t: Type = TypePlaceholder) extends Primitive {
    override def typeScheme: Type = implDT(t => t ->: t)
  }

  @primitive case class IndexAsNat()(override val t: Type = TypePlaceholder) extends Primitive {
    override def typeScheme: Type = implN(n =>
      IndexType(n) ->: NatType
    )
  }

  @primitive case class Iterate()(override val t: Type = TypePlaceholder) extends Primitive {
  ...
  @primitive case class Join()(override val t: Type = TypePlaceholder) extends Primitive {
    override def typeScheme: Type = implN(n => implN(m => implDT(t =>
  ...
  @primitive case class MapSeq()(override val t: Type = TypePlaceholder) extends Primitive {
    override def typeScheme: Type = implN(n => implDT(s => implDT(t =>
      (s ->: t) ->: ArrayType(n, s) ->: ArrayType(n, t)
    )))
  }

  @primitive case class MapSeqUnroll()(override val t: Type = TypePlaceholder) extends Primitive {
    override def typeScheme: Type = implN(n => implDT(s => implDT(t =>
      (s ->: t) ->: ArrayType(n, s) ->: ArrayType(n, t)
    )))
  }

  @primitive case class NatAsIndex()(override val t: Type = TypePlaceholder) extends Primitive {
    override def typeScheme: Type = nFunT(n => NatType ->: IndexType(n))
  }

  // TODO? could be expressed in terms of a pad idx -> val
  @primitive case class PadCst()(override val t: Type = TypePlaceholder) extends Primitive {
  ...
  @primitive case class PadClamp()(override val t: Type = TypePlaceholder) extends Primitive {
    override def typeScheme: Type = implN(n => nFunT(l => nFunT(q => implDT(t =>
      ArrayType(n, t) ->: ArrayType(l + n + q, t)
    ))))
  }

  @primitive case class Partition()(override val t: Type = TypePlaceholder) extends Primitive {
  ...
  @primitive case class Reduce()(override val t: Type = TypePlaceholder) extends Primitive {
    override def typeScheme: Type = implN(n => implDT(t =>
      (t ->: t ->: t) ->: t ->: ArrayType(n, t) ->: t
    ))
  }

  @primitive case class ReduceSeq()(override val t: Type = TypePlaceholder) extends Primitive {
    override def typeScheme: Type = implN(n => implDT(s => implDT(t =>
      (t ->: s ->: t) ->: t ->: ArrayType(n, s) ->: t
    )))
  }

  @primitive case class ReduceSeqUnroll()(override val t: Type = TypePlaceholder) extends Primitive {
    override def typeScheme: Type = implN(n => implDT(s => implDT(t =>
      (t ->: s ->: t) ->: t ->: ArrayType(n, s) ->: t
    )))
  }

  @primitive case class Reorder()(override val t: Type = TypePlaceholder) extends Primitive {
    override def typeScheme: Type = implN(n => implDT(t =>
  ...
  @primitive case class ScanSeq()(override val t: Type = TypePlaceholder) extends Primitive {
    override def typeScheme: Type = implN(n => implDT(s => implDT(t =>
  ...
  @primitive case class Take()(override val t: Type = TypePlaceholder) extends Primitive {
    override def typeScheme: Type = nFunT(n => implN(m => implDT(t =>
      ArrayType(n + m, t) ->: ArrayType(n, t)
    )))
  }

  @primitive case class Transpose()(override val t: Type = TypePlaceholder) extends Primitive {
  ...
  // if-then-else
  @primitive case class Select()(override val t: Type = TypePlaceholder) extends Primitive {
  ...
  @primitive case class AsVectorAligned()(override val t: Type = TypePlaceholder) extends Primitive {
    override def typeScheme: Type = nFunT(n => implN(m => implDT(a =>
      ArrayType(m * n, a) ->: ArrayType(m, VectorType(n, a))
    )))
  }

  @primitive case class AsVector()(override val t: Type = TypePlaceholder) extends Primitive {
    override def typeScheme: Type = nFunT(n => implN(m => implST(t =>
      ArrayType(m * n, t) ->: ArrayType(m, VectorType(n, t))
    )))
  }

  @primitive case class AsScalar()(override val t: Type = TypePlaceholder) extends Primitive {
    override def typeScheme: Type = implN(n => implN(m => implST(t =>
      ArrayType(m, VectorType(n, t)) ->: ArrayType(m * n, t)
    )))
  }

  @primitive case class VectorFromScalar()(override val t: Type = TypePlaceholder) extends Primitive {
    override def typeScheme: Type = implN(n => implST(t =>
      t ->: VectorType(n, t)
    ))
  }

  @primitive case class PrintType(msg: String = "")(override val t: Type = TypePlaceholder) extends Primitive {
    override def typeScheme: Type = implT(t => t ->: t)
  }

  @primitive case class TypeHole(msg: String = "")(override val t: Type = TypePlaceholder) extends Primitive {
