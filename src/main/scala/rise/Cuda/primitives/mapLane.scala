...
final case class mapLane(dim: Int) extends Builder {
  override def toString: String = "mapLane"
  override def primitive: rise.core.Primitive = mapLane.Primitive(dim)()
  override def apply: ToBeTyped[rise.core.Primitive] = toBeTyped(mapLane.Primitive(dim)())
...
object mapLane {
  private final case class Primitive(dim: Int)(override val t: ExprType = TypePlaceholder) extends rise.core.Primitive {
    override val name: String = "mapLane"
